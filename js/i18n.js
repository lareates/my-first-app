...
const I18n = (() => {
  ...
  const MESSAGES = {
    en: {
      ...
      proShortcut: '✨ Pro',
      proTitle: 'Unlock the complete cabin experience.',
      proCopy: 'More immersive scenes,\nsoundscapes and relaxation modes.',
      proPerk1: 'All ambient themes',
      proPerk2: 'Custom sound mixer',
      proPerk3: 'Extended sessions',
      proPerk4: 'Immersive mode',
      proPerk5: 'Future updates',
      proPriceLabel: 'Founder Price',
      proPrice: '$14.99 Lifetime',
      proBuy: 'Unlock Pro',
      proLater: 'Maybe later',
      proLicenseToggle: 'Already purchased? Enter license key',
      proNote: 'Paste the license key from your purchase email.',
      proLicenseLabel: 'License key',
      proLicensePlaceholder: 'Paste your license key',
      proActivate: 'Activate',
      proActivating: 'Activating…',
      proLicenseRequired: 'Please enter your license key.',
    ...
    zh: {
      ...
      proBuy: '解锁 Pro',
      proLater: '稍后',
      proLicenseToggle: '已有激活码？点此输入',
      proNote: '将购买邮件中的激活码粘贴到下方即可解锁。',
      proLicenseLabel: '激活码',
      proLicensePlaceholder: '粘贴你的激活码',
      proActivate: '激活',
      proActivating: '验证中…',
      proLicenseRequired: '请输入激活码。',
      proFeature: 'Pro 功能',
    ...
    fr: {
      ...
      proEyebrow: 'AeroCabin Pro',
      proShortcut: '✨ Pro',
      proTitle: 'Débloquez l’expérience cabine complète.',
      proCopy: 'Plus de scènes immersives,\nd’ambiances sonores et de modes de détente.',
      proPerk1: 'Tous les thèmes ambiants',
      proPerk2: 'Mixeur sonore personnalisé',
      proPerk3: 'Sessions prolongées',
      proPerk4: 'Mode immersif',
      proPerk5: 'Nouveautés à venir',
      proPriceLabel: 'Prix fondateur',
      proPrice: '14,99 $ · Accès à vie',
      proBuy: 'Débloquer Pro',
      proLater: 'Plus tard',
      proLicenseToggle: 'Déjà acheté ? Saisir la clé',
      proNote: 'Collez la clé reçue par e-mail après l’achat.',
      proLicenseLabel: 'Clé de licence',
      proLicensePlaceholder: 'Collez votre clé de licence',
      proActivate: 'Activer',
      proActivating: 'Activation…',
      proLicenseRequired: 'Veuillez saisir votre clé de licence.',
