...
const I18n = (() => {
  ...
  const MESSAGES = {
    en: {
      ...
      theaterYt: 'Browser Fullscreen',
      theaterCn: 'Browser Fullscreen',
      ...
      proNote: 'Purchase first, then paste your license key above to unlock Pro.',
    ...
    zh: {
      ...
      proBuy: 'Buy with Lemon Squeezy · $4.99',
      proLater: 'Maybe later',
      proNote: '购买后，将邮件中的激活码粘贴到上方输入框即可解锁 Pro。',
      proLicenseLabel: '激活码',
    ...
    fr: {
      ...
      theaterYt: 'Plein écran navigateur',
      theaterCn: 'Plein écran navigateur',
      ...
      proLater: 'Plus tard',
      proNote: 'Achetez d’abord, puis collez votre clé de licence ci-dessus.',
