...
const I18n = (() => {
  ...
  const MESSAGES = {
    en: {
      ...
      proCopy: 'Unlock the complete cabin experience.',
      proPerk1: 'More relaxation scenes',
      proPerk2: 'Camping atmospheres',
      proPerk3: 'ASMR mixer',
      proPerk4: 'Future updates',
      proEmailLabel: 'Email',
      proEmailPlaceholder: 'Your email address',
      proNotify: 'Notify me',
    ...
    fr: {
      ...
      proShortcut: '✨ Pro',
      proTitle: 'AeroCabin Pro',
      proCopy: 'Débloquez l’expérience cabine complète.',
      proPerk1: 'Plus de scènes de détente',
      proPerk2: 'Ambiances camping',
      proPerk3: 'Mixeur ASMR',
      proPerk4: 'Nouveautés à venir',
      proEmailLabel: 'E-mail',
      proEmailPlaceholder: 'Votre adresse e-mail',
