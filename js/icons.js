...
const ICONS = {
  ...
  favorite: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.2l2.86 5.8 6.4.93-4.63 4.52 1.09 6.38L12 17.9l-5.72 3.01 1.09-6.38L2.74 8.93l6.4-.93z"/></svg>',
  ...
  moon: '<svg viewBox="0 0 48 48"><defs><linearGradient id="gMoon" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#c3c0ff"/><stop offset="100%" stop-color="#3626ce"/></linearGradient><mask id="mMoon"><rect width="48" height="48" fill="#fff"/><circle cx="32" cy="18" r="16" fill="#000"/></mask></defs><circle cx="24" cy="24" r="20" fill="url(#gMoon)" mask="url(#mMoon)" opacity=".95"/></svg>',
